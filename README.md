...
- **Backend:** Laravel – featuring [simple routing](https://laravel.com/docs/routing), [dependency injection](https://laravel.com/docs/container), [Eloquent ORM](https://laravel.com/docs/eloquent), [migrations](https://laravel.com/docs/migrations), [queues](https://laravel.com/docs/queues), and [real-time events](https://laravel.com/docs/broadcasting)
- **Frontend:** React 19, TypeScript, Tailwind CSS
- **Components:** [shadcn/ui](https://ui.shadcn.com) and [radix-ui](https://www.radix-ui.com)
...
- **Laracasts:** [laracasts.com](https://laracasts.com) – thousands of video tutorials on Laravel, PHP, testing, and JavaScript
...
Please review and abide by the [Code of Conduct](https://laravel.com/docs/contributions#code-of-conduct) to ensure our community remains welcoming to all.
